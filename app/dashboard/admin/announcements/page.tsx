...
const categoryColors: Record<string, string> = {
    hostel_rules: "text-indigo-400 border-indigo-500/50",
    event: "text-purple-400 border-purple-500/50",
    maintenance: "text-orange-400 border-orange-500/50",
    general: "text-gray-400 border-gray-500/50",
    urgent: "text-red-400 border-red-500/50",
    menu_update: "text-blue-400 border-blue-500/50",
    service_info: "text-green-400 border-green-500/50",
    timing_change: "text-yellow-400 border-yellow-500/50",
    special_meal: "text-cyan-400 border-cyan-500/50"
}
    ...
    return (
        <div className="container mx-auto p-4 md:p-6 lg:p-8 space-y-6 max-w-7xl">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold">Manage Announcements</h1>
                                        ...
                                        <div className="flex-1 space-y-3">
                                            <div className="flex flex-wrap items-center gap-2">
                                                {announcement.active && !expired ? (
                                                    <span className="px-2 py-1 rounded-md text-xs font-medium bg-green-500/10 text-green-500 border border-green-500/20">
                                                        ACTIVE
                                                    </span>
                                                ) : (
                                                ...
                                                {expired && (
                                                    <span className="px-2 py-1 rounded-md text-xs font-medium bg-red-500/10 text-red-500 border border-red-500/20">
                                                        EXPIRED
                                                    </span>
                                                )}
                                                <span className={`px-2 py-1 rounded-md text-xs font-medium border ${priorityColors[announcement.priority]}`}>
