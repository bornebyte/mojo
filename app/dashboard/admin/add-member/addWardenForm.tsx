...
export default function AddWardenForm({ user }: { user: UserPayload }) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        const res = await createUser(values.username, values.email, values.phone, values.password, 'warden', values.email, user.name, user.usn_id, user.role);
