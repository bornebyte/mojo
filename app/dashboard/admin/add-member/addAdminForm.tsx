...
export default function AddAdminForm({ user }: { usn_id: string; role: string; name: string; email: string }) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        const res = await createAdmin(values.username, values.email, values.phone, values.password, user.name, user.usn_id)
